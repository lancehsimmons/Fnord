...
const How = () => {
  return (
    <div>
      ...
      <p>Fnord offers access to the Void as a means of subverting your own preconceptions and perhaps generating new exciting avenues of thought.</p>
      <br />
      <h5>Fnord invites you to indulge with reckless abandon.</h5>
    </div>
  )
}
